      ...
      <div className="w-64 flex-shrink-0">
        <div
          className={`${sidebar ? "w-24" : "w-64"
            } flex-shrink-0 shadow-md max-h-screen overflow-scroll bg-gray-50 fixed`}
        >
          <button
            className={`absolute top-[3%]  p-2 rounded-full bg-white shadow-md hover:shadow cursor-pointer ${sidebar ? "-right-[20%]" : "-right-[0%]"
              }`}
            onClick={() => {
